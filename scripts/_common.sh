...
dockerapp_ynh_rm_containers () {
    # Stop and remove Docker containers associated with the application
    docker-compose -f /home/yunohost.app/BunkerWeb/scripts/docker/docker-compose.yml down -v --remove-orphans
}
